                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div className="footer-widget  px-4">
                           <h1 className="text-light fw-bold">LifeCare</h1>
                            ...
                            <ul>
                                ...
                                <li><Nav to="#">info@domain.coms</Nav></li>
                                <li><Nav to="#">Flat 25, King Street, California.</Nav></li>
                            </ul>
                        </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div className="footer-widget px-4">
                            ...
                            <ul>
                                ...
                                <li><Nav to="#">Children's Emergency</Nav></li>
                                <li><Nav to="#">Neurology Department</Nav></li>
                                <li><Nav to="#">Urology Department</Nav></li>
                                <li><Nav to="#">Valve Diseases Department</Nav></li>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div className="footer-widget px-4">
                            ...
                            <ul>
                                <li><Nav to="#">Mon : 9:00 AM - 9:00 PM</Nav></li>
                                <li><Nav to="#">Tues : 9:00 AM - 9:00 PM</Nav></li>
                                <li><Nav to="#">Wed : 9:00 AM - 9:00 PM</Nav></li>
                                <li><Nav to="#">Thurs : 9:00 AM - 9:00 PM</Nav></li>
                                <li><Nav to="#">Fri : 9:00 AM - 9:00 PM</Nav></li>
                                <li><Nav to="#">Sat : 9:00 AM - 9:00 PM</Nav></li>
                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 col-md-6">
                            <div className="copyright">
                                <p>Copyright © by SAIFUN NAHAR SUMI All rights reserved</p>
                            </div>
                        </div>
                        <div className="col-xl-6 col-lg-6 col-md-6">
